...
func (enum DatabaseBackupStatus) String() string {
	if enum == "" {
		// return default value if empty
		return string(DatabaseBackupStatusUnknown)
	}
	return string(enum)
}
...
func (enum EndpointPrivateNetworkDetailsProvisioningMode) String() string {
	if enum == "" {
		// return default value if empty
		return string(EndpointPrivateNetworkDetailsProvisioningModeStatic)
	}
	return string(enum)
}
...
func (enum ListDatabaseBackupsRequestOrderBy) String() string {
	if enum == "" {
		// return default value if empty
		return string(ListDatabaseBackupsRequestOrderByCreatedAtAsc)
	}
	return string(enum)
}
...
// Internal usage only
func (r *ListDatabaseBackupsResponse) UnsafeAppend(res any) (uint32, error) {
...
// UnsafeAppend should not be used
// Internal usage only
func (r *ListDatabaseEnginesResponse) UnsafeAppend(res any) (uint32, error) {
...
// UnsafeAppend should not be used
// Internal usage only
func (r *ListInstanceACLRulesResponse) UnsafeAppend(res any) (uint32, error) {
...
// UnsafeAppend should not be used
// Internal usage only
func (r *ListInstancesResponse) UnsafeAppend(res any) (uint32, error) {
...
// UnsafeAppend should not be used
// Internal usage only
func (r *ListPrivilegesResponse) UnsafeAppend(res any) (uint32, error) {
