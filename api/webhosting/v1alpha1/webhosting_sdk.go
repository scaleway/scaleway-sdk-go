...
import (
	...
	"gitlab.infra.online.net/devtools/scaleway-sdk-go-internal/webhosting/v1alpha1/internal/errors"
	"gitlab.infra.online.net/devtools/scaleway-sdk-go-internal/webhosting/v1alpha1/internal/marshaler"
	"gitlab.infra.online.net/devtools/scaleway-sdk-go-internal/webhosting/v1alpha1/internal/parameter"
	"gitlab.infra.online.net/devtools/scaleway-sdk-go-internal/webhosting/v1alpha1/namegenerator"
	"gitlab.infra.online.net/devtools/scaleway-sdk-go-internal/webhosting/v1alpha1/scw"
)
...
type DediboxHostingType string

const (
	DediboxHostingTypeUnknownType = DediboxHostingType("unknown_type")
	DediboxHostingTypeClassic     = DediboxHostingType("classic")
	DediboxHostingTypeCpanel      = DediboxHostingType("cpanel")
)

func (enum DediboxHostingType) String() string {
	if enum == "" {
		// return default value if empty
		return "unknown_type"
	}
...
func (enum DediboxHostingType) MarshalJSON() ([]byte, error) {
	return []byte(fmt.Sprintf(`"%s"`, enum)), nil
}

func (enum *DediboxHostingType) UnmarshalJSON(data []byte) error {
	tmp := ""
	...
	*enum = DediboxHostingType(DediboxHostingType(tmp).String())
	return nil
}
...
type ListDediboxHostingsRequestOrderBy string

const (
	ListDediboxHostingsRequestOrderByCreatedAtAsc  = ListDediboxHostingsRequestOrderBy("created_at_asc")
	ListDediboxHostingsRequestOrderByCreatedAtDesc = ListDediboxHostingsRequestOrderBy("created_at_desc")
)

func (enum ListDediboxHostingsRequestOrderBy) String() string {
	if enum == "" {
		// return default value if empty
...
func (enum ListDediboxHostingsRequestOrderBy) MarshalJSON() ([]byte, error) {
	return []byte(fmt.Sprintf(`"%s"`, enum)), nil
}

func (enum *ListDediboxHostingsRequestOrderBy) UnmarshalJSON(data []byte) error {
	tmp := ""
	...
	*enum = ListDediboxHostingsRequestOrderBy(ListDediboxHostingsRequestOrderBy(tmp).String())
	return nil
}
...
// DediboxHosting: dedibox hosting.
type DediboxHosting struct {
	// DediboxID: dedibox hosting ID.
	DediboxID uint32 `json:"dedibox_id"`

	// Domain: dedibox hosting domain.
	Domain string `json:"domain"`

	// OfferID: offer ID.
	OfferID string `json:"offer_id"`

	// Type: dedibox hosting type.
	// Default value: unknown_type
	Type DediboxHostingType `json:"type"`
}
...
// DediboxAPIListDediboxHostingsRequest: dedibox api list dedibox hostings request.
type DediboxAPIListDediboxHostingsRequest struct {
	// Region: region to target. If none is passed will use default region from the config.
	Region scw.Region `json:"-"`
	...
	OrderBy ListDediboxHostingsRequestOrderBy `json:"-"`

	// OrganizationID: organization ID of the Dedibox hostings.
	OrganizationID string `json:"-"`
}

// DediboxAPIMigrateDediboxHostingRequest: dedibox api migrate dedibox hosting request.
type DediboxAPIMigrateDediboxHostingRequest struct {
	// Region: region to target. If none is passed will use default region from the config.
	Region scw.Region `json:"-"`

	// OrganizationID: organization ID to attach the new migrated hosting to.
	OrganizationID string `json:"organization_id"`

	// ProjectID: project ID to attach the new migrated hosting to.
	ProjectID string `json:"project_id"`

	// Email: email provided while generating the token.
	Email string `json:"email"`

	// Token: token generated by Dedibox console to validate the hosting migration.
	Token string `json:"token"`

	// Domain: domain linked with the dedibox hosting.
	Domain string `json:"domain"`
}
...
// ListDediboxHostingsResponse: list dedibox hostings response.
type ListDediboxHostingsResponse struct {
	// TotalCount: total number of returned Dedibox hostings.
	TotalCount uint32 `json:"total_count"`

	// DediboxHostings: list of Dedibox hostings.
	DediboxHostings []*DediboxHosting `json:"dedibox_hostings"`
}

// UnsafeGetTotalCount should not be used
// Internal usage only
func (r *ListDediboxHostingsResponse) UnsafeGetTotalCount() uint32 {
	return r.TotalCount
}

// UnsafeAppend should not be used
// Internal usage only
func (r *ListDediboxHostingsResponse) UnsafeAppend(res interface{}) (uint32, error) {
	results, ok := res.(*ListDediboxHostingsResponse)
	if !ok {
		return 0, errors.New("%T type cannot be appended to type %T", res, r)
	}

	r.DediboxHostings = append(r.DediboxHostings, results.DediboxHostings...)
	r.TotalCount += uint32(len(results.DediboxHostings))
	return uint32(len(results.DediboxHostings)), nil
}
...
// NewDediboxAPI returns a DediboxAPI object from a Scaleway client.
func NewDediboxAPI(client *scw.Client) *DediboxAPI {
	return &DediboxAPI{
		client: client,
	}
}
func (s *DediboxAPI) Regions() []scw.Region {
	return []scw.Region{scw.RegionFrPar}
}

// ListDediboxHostings: List all Dedibox hostings for Dedibox user ID.
func (s *DediboxAPI) ListDediboxHostings(req *DediboxAPIListDediboxHostingsRequest, opts ...scw.RequestOption) (*ListDediboxHostingsResponse, error) {
	var err error
	...
	scwReq := &scw.ScalewayRequest{
		Method: "GET",
		Path:   "/webhosting/v1alpha1/regions/" + fmt.Sprint(req.Region) + "/dedibox-hostings",
		Query:  query,
	}

	var resp ListDediboxHostingsResponse
...
// MigrateDediboxHosting: Migrate a hosting from Dedibox to Scaleway account.
func (s *DediboxAPI) MigrateDediboxHosting(req *DediboxAPIMigrateDediboxHostingRequest, opts ...scw.RequestOption) (*Hosting, error) {
	var err error
	...
	scwReq := &scw.ScalewayRequest{
		Method: "POST",
		Path:   "/webhosting/v1alpha1/regions/" + fmt.Sprint(req.Region) + "/dedibox-hostings/migrate",
	}
