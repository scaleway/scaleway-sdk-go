...
const (
	...
	defaultVpcgwTimeout       = 5 * time.Minute
)
...
// Internal usage only
func (r *ListGatewayNetworksResponse) UnsafeAppend(res any) (uint64, error) {
...
// UnsafeAppend should not be used
// Internal usage only
func (r *ListGatewaysResponse) UnsafeAppend(res any) (uint64, error) {
...
// UnsafeAppend should not be used
// Internal usage only
func (r *ListPatRulesResponse) UnsafeAppend(res any) (uint64, error) {
...
func (s *API) Zones() []scw.Zone {
	return []scw.Zone{scw.ZoneFrPar1, scw.ZoneFrPar2, scw.ZoneItMil1, scw.ZoneNlAms1, scw.ZoneNlAms2, scw.ZoneNlAms3, scw.ZonePlWaw1, scw.ZonePlWaw2, scw.ZonePlWaw3}
}
