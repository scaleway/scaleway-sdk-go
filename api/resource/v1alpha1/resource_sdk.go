...
type IfrDeploymentInfoStatus string

const (
	IfrDeploymentInfoStatusUnknownStatus = IfrDeploymentInfoStatus("unknown_status")
	IfrDeploymentInfoStatusCreating      = IfrDeploymentInfoStatus("creating")
	IfrDeploymentInfoStatusDeploying     = IfrDeploymentInfoStatus("deploying")
	IfrDeploymentInfoStatusReady         = IfrDeploymentInfoStatus("ready")
	IfrDeploymentInfoStatusError         = IfrDeploymentInfoStatus("error")
	IfrDeploymentInfoStatusDeleting      = IfrDeploymentInfoStatus("deleting")
	IfrDeploymentInfoStatusLocked        = IfrDeploymentInfoStatus("locked")
)

func (enum IfrDeploymentInfoStatus) String() string {
	if enum == "" {
		// return default value if empty
		return "unknown_status"
	}
...
func (enum IfrDeploymentInfoStatus) MarshalJSON() ([]byte, error) {
	return []byte(fmt.Sprintf(`"%s"`, enum)), nil
}

func (enum *IfrDeploymentInfoStatus) UnmarshalJSON(data []byte) error {
	tmp := ""
	...
	*enum = IfrDeploymentInfoStatus(IfrDeploymentInfoStatus(tmp).String())
	return nil
}
...
type KmsKeyInfoState string

const (
	KmsKeyInfoStateUnknownState       = KmsKeyInfoState("unknown_state")
	KmsKeyInfoStateEnabled            = KmsKeyInfoState("enabled")
	KmsKeyInfoStateDisabled           = KmsKeyInfoState("disabled")
	KmsKeyInfoStatePendingKeyMaterial = KmsKeyInfoState("pending_key_material")
)

func (enum KmsKeyInfoState) String() string {
	if enum == "" {
		// return default value if empty
...
func (enum KmsKeyInfoState) MarshalJSON() ([]byte, error) {
	return []byte(fmt.Sprintf(`"%s"`, enum)), nil
}

func (enum *KmsKeyInfoState) UnmarshalJSON(data []byte) error {
	tmp := ""
	...
	*enum = KmsKeyInfoState(KmsKeyInfoState(tmp).String())
	return nil
}
...
func (enum KmsKeyInfoUsage) MarshalJSON() ([]byte, error) {
	return []byte(fmt.Sprintf(`"%s"`, enum)), nil
}

func (enum *KmsKeyInfoUsage) UnmarshalJSON(data []byte) error {
	tmp := ""
	...
	*enum = KmsKeyInfoUsage(KmsKeyInfoUsage(tmp).String())
	return nil
}
...
// EdgPipelineInfo: edg pipeline info.
type EdgPipelineInfo struct {
}
...
// IamAPIKeyInfo: iam api key info.
type IamAPIKeyInfo struct {
	AccessKey string `json:"access_key"`
}

// IfrDeploymentInfo: ifr deployment info.
type IfrDeploymentInfo struct {
	// Status: default value: unknown_status
	Status IfrDeploymentInfoStatus `json:"status"`

	NodeType string `json:"node_type"`
}

// IfrModelInfo: ifr model info.
type IfrModelInfo struct {
...
type Resource struct {
	...
	// Deprecated
	// Precisely one of InstanceServerInfo, InstanceIPInfo, InstanceVolumeInfo, InstanceImageInfo, InstanceClusterInfo, InstanceHypervisorInfo, InstanceSessionInfo, AccountOrganizationInfo, AccountUserInfo, AccountTokenInfo, AccountUserLogInfo, AccountAbuseInfo, AccountProjectInfo, K8sClusterInfo, K8sPoolInfo, K8sNodeInfo, BillingDiscountInfo, BillingInvoiceInfo, PaymentCardInfo, DomainDomainInfo, DNSZoneInfo, VpcPrivateNetworkInfo, VpcVpcInfo, VpgGatewayInfo, VpgInstanceInfo, VpgIPInfo, VpgNetworkInfo, AppleSiliconMacInfo, AppleSiliconServerInfo, RdbInstanceInfo, RdbSnapshotInfo, RdbBackupInfo, BrmServerInfo, BrmDcimServerInfo, FipIPInfo, LbaasServerInfo, ServerlessNamespaceInfo, ServerlessFunctionInfo, ServerlessContainerInfo, ServerlessDomainInfo, ServerlessCronInfo, RedisClusterInfo, SecretInfo, MnqNatsAccountInfo, MnqNatsCredentialsInfo, MnqSqsAccountInfo, MnqSqsCredentialsInfo, MnqSnsAccountInfo, MnqSnsCredentialsInfo, SbsVolumeInfo, SbsSnapshotInfo, IamAPIKeyInfo, KeyInfo, IfrModelInfo, IfrDeploymentInfo, EdgPipelineInfo must be set.
	IamAPIKeyInfo *IamAPIKeyInfo `json:"iam_api_key_info,omitempty"`

	// Precisely one of InstanceServerInfo, InstanceIPInfo, InstanceVolumeInfo, InstanceImageInfo, InstanceClusterInfo, InstanceHypervisorInfo, InstanceSessionInfo, AccountOrganizationInfo, AccountUserInfo, AccountTokenInfo, AccountUserLogInfo, AccountAbuseInfo, AccountProjectInfo, K8sClusterInfo, K8sPoolInfo, K8sNodeInfo, BillingDiscountInfo, BillingInvoiceInfo, PaymentCardInfo, DomainDomainInfo, DNSZoneInfo, VpcPrivateNetworkInfo, VpcVpcInfo, VpgGatewayInfo, VpgInstanceInfo, VpgIPInfo, VpgNetworkInfo, AppleSiliconMacInfo, AppleSiliconServerInfo, RdbInstanceInfo, RdbSnapshotInfo, RdbBackupInfo, BrmServerInfo, BrmDcimServerInfo, FipIPInfo, LbaasServerInfo, ServerlessNamespaceInfo, ServerlessFunctionInfo, ServerlessContainerInfo, ServerlessDomainInfo, ServerlessCronInfo, RedisClusterInfo, SecretInfo, MnqNatsAccountInfo, MnqNatsCredentialsInfo, MnqSqsAccountInfo, MnqSqsCredentialsInfo, MnqSnsAccountInfo, MnqSnsCredentialsInfo, SbsVolumeInfo, SbsSnapshotInfo, IamAPIKeyInfo, KeyInfo, IfrModelInfo, IfrDeploymentInfo, EdgPipelineInfo must be set.
	KeyInfo *KmsKeyInfo `json:"key_info,omitempty"`

	// Precisely one of InstanceServerInfo, InstanceIPInfo, InstanceVolumeInfo, InstanceImageInfo, InstanceClusterInfo, InstanceHypervisorInfo, InstanceSessionInfo, AccountOrganizationInfo, AccountUserInfo, AccountTokenInfo, AccountUserLogInfo, AccountAbuseInfo, AccountProjectInfo, K8sClusterInfo, K8sPoolInfo, K8sNodeInfo, BillingDiscountInfo, BillingInvoiceInfo, PaymentCardInfo, DomainDomainInfo, DNSZoneInfo, VpcPrivateNetworkInfo, VpcVpcInfo, VpgGatewayInfo, VpgInstanceInfo, VpgIPInfo, VpgNetworkInfo, AppleSiliconMacInfo, AppleSiliconServerInfo, RdbInstanceInfo, RdbSnapshotInfo, RdbBackupInfo, BrmServerInfo, BrmDcimServerInfo, FipIPInfo, LbaasServerInfo, ServerlessNamespaceInfo, ServerlessFunctionInfo, ServerlessContainerInfo, ServerlessDomainInfo, ServerlessCronInfo, RedisClusterInfo, SecretInfo, MnqNatsAccountInfo, MnqNatsCredentialsInfo, MnqSqsAccountInfo, MnqSqsCredentialsInfo, MnqSnsAccountInfo, MnqSnsCredentialsInfo, SbsVolumeInfo, SbsSnapshotInfo, IamAPIKeyInfo, KeyInfo, IfrModelInfo, IfrDeploymentInfo, EdgPipelineInfo must be set.
	IfrModelInfo *IfrModelInfo `json:"ifr_model_info,omitempty"`

	// Precisely one of InstanceServerInfo, InstanceIPInfo, InstanceVolumeInfo, InstanceImageInfo, InstanceClusterInfo, InstanceHypervisorInfo, InstanceSessionInfo, AccountOrganizationInfo, AccountUserInfo, AccountTokenInfo, AccountUserLogInfo, AccountAbuseInfo, AccountProjectInfo, K8sClusterInfo, K8sPoolInfo, K8sNodeInfo, BillingDiscountInfo, BillingInvoiceInfo, PaymentCardInfo, DomainDomainInfo, DNSZoneInfo, VpcPrivateNetworkInfo, VpcVpcInfo, VpgGatewayInfo, VpgInstanceInfo, VpgIPInfo, VpgNetworkInfo, AppleSiliconMacInfo, AppleSiliconServerInfo, RdbInstanceInfo, RdbSnapshotInfo, RdbBackupInfo, BrmServerInfo, BrmDcimServerInfo, FipIPInfo, LbaasServerInfo, ServerlessNamespaceInfo, ServerlessFunctionInfo, ServerlessContainerInfo, ServerlessDomainInfo, ServerlessCronInfo, RedisClusterInfo, SecretInfo, MnqNatsAccountInfo, MnqNatsCredentialsInfo, MnqSqsAccountInfo, MnqSqsCredentialsInfo, MnqSnsAccountInfo, MnqSnsCredentialsInfo, SbsVolumeInfo, SbsSnapshotInfo, IamAPIKeyInfo, KeyInfo, IfrModelInfo, IfrDeploymentInfo, EdgPipelineInfo must be set.
	IfrDeploymentInfo *IfrDeploymentInfo `json:"ifr_deployment_info,omitempty"`

	// Precisely one of InstanceServerInfo, InstanceIPInfo, InstanceVolumeInfo, InstanceImageInfo, InstanceClusterInfo, InstanceHypervisorInfo, InstanceSessionInfo, AccountOrganizationInfo, AccountUserInfo, AccountTokenInfo, AccountUserLogInfo, AccountAbuseInfo, AccountProjectInfo, K8sClusterInfo, K8sPoolInfo, K8sNodeInfo, BillingDiscountInfo, BillingInvoiceInfo, PaymentCardInfo, DomainDomainInfo, DNSZoneInfo, VpcPrivateNetworkInfo, VpcVpcInfo, VpgGatewayInfo, VpgInstanceInfo, VpgIPInfo, VpgNetworkInfo, AppleSiliconMacInfo, AppleSiliconServerInfo, RdbInstanceInfo, RdbSnapshotInfo, RdbBackupInfo, BrmServerInfo, BrmDcimServerInfo, FipIPInfo, LbaasServerInfo, ServerlessNamespaceInfo, ServerlessFunctionInfo, ServerlessContainerInfo, ServerlessDomainInfo, ServerlessCronInfo, RedisClusterInfo, SecretInfo, MnqNatsAccountInfo, MnqNatsCredentialsInfo, MnqSqsAccountInfo, MnqSqsCredentialsInfo, MnqSnsAccountInfo, MnqSnsCredentialsInfo, SbsVolumeInfo, SbsSnapshotInfo, IamAPIKeyInfo, KeyInfo, IfrModelInfo, IfrDeploymentInfo, EdgPipelineInfo must be set.
	EdgPipelineInfo *EdgPipelineInfo `json:"edg_pipeline_info,omitempty"`
}
