...
// Package redis_admin provides methods and message types of the redis_admin v1alpha1 API.
package redis_admin
...
import (
	...
	"gitlab.infra.online.net/devtools/scaleway-sdk-go-internal/redis_admin/v1alpha1/internal/errors"
	"gitlab.infra.online.net/devtools/scaleway-sdk-go-internal/redis_admin/v1alpha1/internal/marshaler"
	"gitlab.infra.online.net/devtools/scaleway-sdk-go-internal/redis_admin/v1alpha1/internal/parameter"
	"gitlab.infra.online.net/devtools/scaleway-sdk-go-internal/redis_admin/v1alpha1/namegenerator"
	"gitlab.infra.online.net/devtools/scaleway-sdk-go-internal/redis_admin/v1alpha1/scw"
	redis_v1alpha1 "gitlab.infra.online.net/devtools/scaleway-sdk-go-internal/redis_admin/v1alpha1/api/redis/v1alpha1"
)
...
type Cluster struct {
	...
	Endpoints []*redis_v1alpha1.Endpoint `json:"endpoints"`
...
func (s *API) GetServiceInfo(req *GetServiceInfoRequest, opts ...scw.RequestOption) (*scw.ServiceInfo, error) {
	...
	scwReq := &scw.ScalewayRequest{
		Method: "GET",
		Path:   "/redis-admin/v1alpha1/zones/" + fmt.Sprint(req.Zone) + "",
	}
...
func (s *API) RedeployCluster(req *RedeployClusterRequest, opts ...scw.RequestOption) (*Cluster, error) {
	...
	scwReq := &scw.ScalewayRequest{
		Method: "POST",
		Path:   "/redis-admin/v1alpha1/zones/" + fmt.Sprint(req.Zone) + "/clusters/" + fmt.Sprint(req.ClusterID) + "/redeploy",
	}
...
func (s *API) ListResources(req *ListResourcesRequest, opts ...scw.RequestOption) (*ListResourcesResponse, error) {
	...
	scwReq := &scw.ScalewayRequest{
		Method: "GET",
		Path:   "/redis-admin/v1alpha1/zones/" + fmt.Sprint(req.Zone) + "/clusters/" + fmt.Sprint(req.ClusterID) + "/resources",
		Query:  query,
	}
...
func (s *API) HotNodeReplace(req *HotNodeReplaceRequest, opts ...scw.RequestOption) (*Node, error) {
	...
	scwReq := &scw.ScalewayRequest{
		Method: "POST",
		Path:   "/redis-admin/v1alpha1/zones/" + fmt.Sprint(req.Zone) + "/clusters/" + fmt.Sprint(req.ClusterID) + "/hot-node-replace",
	}
...
func (s *API) DeleteCluster(req *DeleteClusterRequest, opts ...scw.RequestOption) (*Cluster, error) {
	...
	scwReq := &scw.ScalewayRequest{
		Method: "DELETE",
		Path:   "/redis-admin/v1alpha1/zones/" + fmt.Sprint(req.Zone) + "/clusters/" + fmt.Sprint(req.ClusterID) + "",
	}
...
func (s *API) ListClusters(req *ListClustersRequest, opts ...scw.RequestOption) (*ListClustersResponse, error) {
	...
	scwReq := &scw.ScalewayRequest{
		Method: "GET",
		Path:   "/redis-admin/v1alpha1/zones/" + fmt.Sprint(req.Zone) + "/clusters",
		Query:  query,
	}
...
func (s *API) ListClusterEvents(req *ListClusterEventsRequest, opts ...scw.RequestOption) (*ListClusterEventsResponse, error) {
	...
	scwReq := &scw.ScalewayRequest{
		Method: "GET",
		Path:   "/redis-admin/v1alpha1/zones/" + fmt.Sprint(req.Zone) + "/clusters/" + fmt.Sprint(req.ClusterID) + "/events",
		Query:  query,
	}
...
func (s *API) ListClusterDeployments(req *ListClusterDeploymentsRequest, opts ...scw.RequestOption) (*ListClusterDeploymentsResponse, error) {
	...
	scwReq := &scw.ScalewayRequest{
		Method: "GET",
		Path:   "/redis-admin/v1alpha1/zones/" + fmt.Sprint(req.Zone) + "/clusters/" + fmt.Sprint(req.ClusterID) + "/deployments",
		Query:  query,
	}
