...
const (
	...
	ResourceTypeInstancePrivateNetworkInterface = ResourceType("instance_private_network_interface")
	...
	ResourceTypeVpcConnector                    = ResourceType("vpc_connector")
	ResourceTypeVpcIngressRule                  = ResourceType("vpc_ingress_rule")
	...
	ResourceTypeEdgeServicesVpcEndpoint         = ResourceType("edge_services_vpc_endpoint")
	...
	ResourceTypeServerlessFunctionsTrigger      = ResourceType("serverless_functions_trigger")
	ResourceTypeWoflWorkflowDefinition          = ResourceType("wofl_workflow_definition")
	ResourceTypeWoflWorkflowRun                 = ResourceType("wofl_workflow_run")
	ResourceTypeWoflWorkflowVersion             = ResourceType("wofl_workflow_version")
)
...
const (
	RunStatusUnknownRunStatus = RunStatus("unknown_run_status")
	...
	RunStatusInterrupting     = RunStatus("interrupting")
	RunStatusInterrupted      = RunStatus("interrupted")
	RunStatusPausing          = RunStatus("pausing")
	RunStatusPaused           = RunStatus("paused")
)

func (enum RunStatus) String() string {
	if enum == "" {
		// return default value if empty
		return string(RunStatusUnknownRunStatus)
	}
	return string(enum)
}

func (enum RunStatus) Values() []RunStatus {
	return []RunStatus{
		"unknown_run_status",
		"initialized",
		"validated",
...
func (enum RunStatus) MarshalJSON() ([]byte, error) {
	return []byte(fmt.Sprintf(`"%s"`, enum)), nil
}

func (enum *RunStatus) UnmarshalJSON(data []byte) error {
	tmp := ""
	...
	*enum = RunStatus(RunStatus(tmp).String())
	return nil
}

type ServerlessContainersTriggerInfoSourceType string

const (
	ServerlessContainersTriggerInfoSourceTypeUnknownSourceType = ServerlessContainersTriggerInfoSourceType("unknown_source_type")
	ServerlessContainersTriggerInfoSourceTypeCron              = ServerlessContainersTriggerInfoSourceType("cron")
	ServerlessContainersTriggerInfoSourceTypeSqs               = ServerlessContainersTriggerInfoSourceType("sqs")
	ServerlessContainersTriggerInfoSourceTypeNats              = ServerlessContainersTriggerInfoSourceType("nats")
)

func (enum ServerlessContainersTriggerInfoSourceType) String() string {
	if enum == "" {
		// return default value if empty
		return string(ServerlessContainersTriggerInfoSourceTypeUnknownSourceType)
	}
	return string(enum)
}

func (enum ServerlessContainersTriggerInfoSourceType) Values() []ServerlessContainersTriggerInfoSourceType {
	return []ServerlessContainersTriggerInfoSourceType{
		"unknown_source_type",
		"cron",
		"sqs",
		"nats",
...
func (enum ServerlessContainersTriggerInfoSourceType) MarshalJSON() ([]byte, error) {
	return []byte(fmt.Sprintf(`"%s"`, enum)), nil
}

func (enum *ServerlessContainersTriggerInfoSourceType) UnmarshalJSON(data []byte) error {
	tmp := ""
	...
	*enum = ServerlessContainersTriggerInfoSourceType(ServerlessContainersTriggerInfoSourceType(tmp).String())
	return nil
}

type ServerlessFunctionsTriggerInfoInputType string

const (
	ServerlessFunctionsTriggerInfoInputTypeUnknownInputType = ServerlessFunctionsTriggerInfoInputType("unknown_input_type")
	ServerlessFunctionsTriggerInfoInputTypeScwSqs           = ServerlessFunctionsTriggerInfoInputType("scw_sqs")
	ServerlessFunctionsTriggerInfoInputTypeScwNats          = ServerlessFunctionsTriggerInfoInputType("scw_nats")
)

func (enum ServerlessFunctionsTriggerInfoInputType) String() string {
	if enum == "" {
		// return default value if empty
		return string(ServerlessFunctionsTriggerInfoInputTypeUnknownInputType)
	}
	return string(enum)
}

func (enum ServerlessFunctionsTriggerInfoInputType) Values() []ServerlessFunctionsTriggerInfoInputType {
	return []ServerlessFunctionsTriggerInfoInputType{
		"unknown_input_type",
		"scw_sqs",
		"scw_nats",
	}
...
func (enum ServerlessFunctionsTriggerInfoInputType) MarshalJSON() ([]byte, error) {
	return []byte(fmt.Sprintf(`"%s"`, enum)), nil
}

func (enum *ServerlessFunctionsTriggerInfoInputType) UnmarshalJSON(data []byte) error {
	tmp := ""
	...
	*enum = ServerlessFunctionsTriggerInfoInputType(ServerlessFunctionsTriggerInfoInputType(tmp).String())
	return nil
}
...
// AppleSiliconRunnerInfo: apple silicon runner info.
type AppleSiliconRunnerInfo struct {
	ID string `json:"id"`
...
// EdgeServicesVPCEndpointInfo: edge services vpc endpoint info.
type EdgeServicesVPCEndpointInfo struct {
...
// InstancePrivateNetworkInterfaceInfo: instance private network interface info.
type InstancePrivateNetworkInterfaceInfo struct {
	PrivateNetworkID string `json:"private_network_id"`
...
// ObservabilityAlertRuleInfo: observability alert rule info.
type ObservabilityAlertRuleInfo struct {
	RuleIDs []string `json:"rule_ids"`
}

// ObservabilityContactPointInfo: observability contact point info.
type ObservabilityContactPointInfo struct {
	Email string `json:"email"`
}
...
// ServerlessContainersDomainInfo: serverless containers domain info.
type ServerlessContainersDomainInfo struct {
	ContainerID string `json:"container_id"`
}

// ServerlessContainersNamespaceInfo: serverless containers namespace info.
type ServerlessContainersNamespaceInfo struct{}

// ServerlessContainersTriggerInfo: serverless containers trigger info.
type ServerlessContainersTriggerInfo struct {
	ContainerID string `json:"container_id"`

	// SourceType: default value: unknown_source_type
	SourceType ServerlessContainersTriggerInfoSourceType `json:"source_type"`
}

// ServerlessFunctionsCronInfo: serverless functions cron info.
type ServerlessFunctionsCronInfo struct {
	FunctionID string `json:"function_id"`
}

// ServerlessFunctionsDomainInfo: serverless functions domain info.
type ServerlessFunctionsDomainInfo struct {
	FunctionID string `json:"function_id"`
}
...
// ServerlessFunctionsNamespaceInfo: serverless functions namespace info.
type ServerlessFunctionsNamespaceInfo struct{}

// ServerlessFunctionsTriggerInfo: serverless functions trigger info.
type ServerlessFunctionsTriggerInfo struct {
	FunctionID string `json:"function_id"`

	// InputType: default value: unknown_input_type
	InputType ServerlessFunctionsTriggerInfoInputType `json:"input_type"`
}

// VpcConnectorInfo: vpc connector info.
...
// VpcGwGatewayInfo: vpc gw gateway info.
type VpcGwGatewayInfo struct {
	VpcID *string `json:"vpc_id"`
...
// VpcGwGatewayNetworkInfo: vpc gw gateway network info.
type VpcGwGatewayNetworkInfo struct {
	GatewayID string `json:"gateway_id"`

	PnID string `json:"pn_id"`

	Address *scw.IPNet `json:"address"`
}

// VpcIngressRuleInfo: vpc ingress rule info.
type VpcIngressRuleInfo struct {
	VpcID string `json:"vpc_id"`
...
// WoflWorkflowDefinitionInfo: wofl workflow definition info.
type WoflWorkflowDefinitionInfo struct {
	Name string `json:"name"`

	Description *string `json:"description"`
}

// WoflWorkflowRunInfo: wofl workflow run info.
type WoflWorkflowRunInfo struct {
	WorkflowDefinitionID string `json:"workflow_definition_id"`

	WorkflowDefinitionName *string `json:"workflow_definition_name"`

	// Status: default value: unknown_run_status
	Status RunStatus `json:"status"`
}

// WoflWorkflowVersionInfo: wofl workflow version info.
type WoflWorkflowVersionInfo struct {
	WorkflowDefinitionID string `json:"workflow_definition_id"`
...
type Resource struct {
	...
	// Precisely one of SecmSecretInfo, SecmSecretVersionInfo, KubeClusterInfo, KubePoolInfo, KubeNodeInfo, KubeACLInfo, KeymKeyInfo, SecretManagerSecretInfo, SecretManagerVersionInfo, KeyManagerKeyInfo, AccountUserInfo, AccountOrganizationInfo, InstanceServerInfo, AppleSiliconServerInfo, AccountProjectInfo, BaremetalServerInfo, BaremetalSettingInfo, IpamIPInfo, LoadBalancerLBInfo, LoadBalancerIPInfo, LoadBalancerFrontendInfo, LoadBalancerBackendInfo, LoadBalancerRouteInfo, LoadBalancerACLInfo, LoadBalancerCertificateInfo, EdgeServicesPlanInfo, EdgeServicesPipelineInfo, EdgeServicesDNSStageInfo, EdgeServicesTLSStageInfo, EdgeServicesCacheStageInfo, EdgeServicesRouteStageInfo, EdgeServicesRouteRulesInfo, EdgeServicesWafStageInfo, EdgeServicesBackendStageInfo, AccountContractSignatureInfo, VpcSubnetInfo, VpcRouteInfo, VpcPrivateNetworkInfo, AuditTrailExportJobInfo, VpcGwGatewayInfo, VpcGwGatewayNetworkInfo, AppleSiliconRunnerInfo, AuditTrailAlertRuleInfo, VpcConnectorInfo, InstancePrivateNetworkInterfaceInfo, VpcIngressRuleInfo, ObservabilityContactPointInfo, ObservabilityAlertRuleInfo, EdgeServicesVpcEndpointInfo, AuditTrailCustomAlertRuleInfo, ServerlessContainersNamespaceInfo, ServerlessContainersContainerInfo, ServerlessContainersDomainInfo, ServerlessContainersTriggerInfo, ServerlessFunctionsNamespaceInfo, ServerlessFunctionsFunctionInfo, ServerlessFunctionsDomainInfo, ServerlessFunctionsCronInfo, ServerlessFunctionsTriggerInfo, WoflWorkflowDefinitionInfo, WoflWorkflowRunInfo, WoflWorkflowVersionInfo must be set.
	ServerlessContainersNamespaceInfo *ServerlessContainersNamespaceInfo `json:"serverless_containers_namespace_info,omitempty"`

	// Precisely one of SecmSecretInfo, SecmSecretVersionInfo, KubeClusterInfo, KubePoolInfo, KubeNodeInfo, KubeACLInfo, KeymKeyInfo, SecretManagerSecretInfo, SecretManagerVersionInfo, KeyManagerKeyInfo, AccountUserInfo, AccountOrganizationInfo, InstanceServerInfo, AppleSiliconServerInfo, AccountProjectInfo, BaremetalServerInfo, BaremetalSettingInfo, IpamIPInfo, LoadBalancerLBInfo, LoadBalancerIPInfo, LoadBalancerFrontendInfo, LoadBalancerBackendInfo, LoadBalancerRouteInfo, LoadBalancerACLInfo, LoadBalancerCertificateInfo, EdgeServicesPlanInfo, EdgeServicesPipelineInfo, EdgeServicesDNSStageInfo, EdgeServicesTLSStageInfo, EdgeServicesCacheStageInfo, EdgeServicesRouteStageInfo, EdgeServicesRouteRulesInfo, EdgeServicesWafStageInfo, EdgeServicesBackendStageInfo, AccountContractSignatureInfo, VpcSubnetInfo, VpcRouteInfo, VpcPrivateNetworkInfo, AuditTrailExportJobInfo, VpcGwGatewayInfo, VpcGwGatewayNetworkInfo, AppleSiliconRunnerInfo, AuditTrailAlertRuleInfo, VpcConnectorInfo, InstancePrivateNetworkInterfaceInfo, VpcIngressRuleInfo, ObservabilityContactPointInfo, ObservabilityAlertRuleInfo, EdgeServicesVpcEndpointInfo, AuditTrailCustomAlertRuleInfo, ServerlessContainersNamespaceInfo, ServerlessContainersContainerInfo, ServerlessContainersDomainInfo, ServerlessContainersTriggerInfo, ServerlessFunctionsNamespaceInfo, ServerlessFunctionsFunctionInfo, ServerlessFunctionsDomainInfo, ServerlessFunctionsCronInfo, ServerlessFunctionsTriggerInfo, WoflWorkflowDefinitionInfo, WoflWorkflowRunInfo, WoflWorkflowVersionInfo must be set.
	ServerlessContainersContainerInfo *ServerlessContainersContainerInfo `json:"serverless_containers_container_info,omitempty"`

	// Precisely one of SecmSecretInfo, SecmSecretVersionInfo, KubeClusterInfo, KubePoolInfo, KubeNodeInfo, KubeACLInfo, KeymKeyInfo, SecretManagerSecretInfo, SecretManagerVersionInfo, KeyManagerKeyInfo, AccountUserInfo, AccountOrganizationInfo, InstanceServerInfo, AppleSiliconServerInfo, AccountProjectInfo, BaremetalServerInfo, BaremetalSettingInfo, IpamIPInfo, LoadBalancerLBInfo, LoadBalancerIPInfo, LoadBalancerFrontendInfo, LoadBalancerBackendInfo, LoadBalancerRouteInfo, LoadBalancerACLInfo, LoadBalancerCertificateInfo, EdgeServicesPlanInfo, EdgeServicesPipelineInfo, EdgeServicesDNSStageInfo, EdgeServicesTLSStageInfo, EdgeServicesCacheStageInfo, EdgeServicesRouteStageInfo, EdgeServicesRouteRulesInfo, EdgeServicesWafStageInfo, EdgeServicesBackendStageInfo, AccountContractSignatureInfo, VpcSubnetInfo, VpcRouteInfo, VpcPrivateNetworkInfo, AuditTrailExportJobInfo, VpcGwGatewayInfo, VpcGwGatewayNetworkInfo, AppleSiliconRunnerInfo, AuditTrailAlertRuleInfo, VpcConnectorInfo, InstancePrivateNetworkInterfaceInfo, VpcIngressRuleInfo, ObservabilityContactPointInfo, ObservabilityAlertRuleInfo, EdgeServicesVpcEndpointInfo, AuditTrailCustomAlertRuleInfo, ServerlessContainersNamespaceInfo, ServerlessContainersContainerInfo, ServerlessContainersDomainInfo, ServerlessContainersTriggerInfo, ServerlessFunctionsNamespaceInfo, ServerlessFunctionsFunctionInfo, ServerlessFunctionsDomainInfo, ServerlessFunctionsCronInfo, ServerlessFunctionsTriggerInfo, WoflWorkflowDefinitionInfo, WoflWorkflowRunInfo, WoflWorkflowVersionInfo must be set.
	ServerlessContainersDomainInfo *ServerlessContainersDomainInfo `json:"serverless_containers_domain_info,omitempty"`

	// Precisely one of SecmSecretInfo, SecmSecretVersionInfo, KubeClusterInfo, KubePoolInfo, KubeNodeInfo, KubeACLInfo, KeymKeyInfo, SecretManagerSecretInfo, SecretManagerVersionInfo, KeyManagerKeyInfo, AccountUserInfo, AccountOrganizationInfo, InstanceServerInfo, AppleSiliconServerInfo, AccountProjectInfo, BaremetalServerInfo, BaremetalSettingInfo, IpamIPInfo, LoadBalancerLBInfo, LoadBalancerIPInfo, LoadBalancerFrontendInfo, LoadBalancerBackendInfo, LoadBalancerRouteInfo, LoadBalancerACLInfo, LoadBalancerCertificateInfo, EdgeServicesPlanInfo, EdgeServicesPipelineInfo, EdgeServicesDNSStageInfo, EdgeServicesTLSStageInfo, EdgeServicesCacheStageInfo, EdgeServicesRouteStageInfo, EdgeServicesRouteRulesInfo, EdgeServicesWafStageInfo, EdgeServicesBackendStageInfo, AccountContractSignatureInfo, VpcSubnetInfo, VpcRouteInfo, VpcPrivateNetworkInfo, AuditTrailExportJobInfo, VpcGwGatewayInfo, VpcGwGatewayNetworkInfo, AppleSiliconRunnerInfo, AuditTrailAlertRuleInfo, VpcConnectorInfo, InstancePrivateNetworkInterfaceInfo, VpcIngressRuleInfo, ObservabilityContactPointInfo, ObservabilityAlertRuleInfo, EdgeServicesVpcEndpointInfo, AuditTrailCustomAlertRuleInfo, ServerlessContainersNamespaceInfo, ServerlessContainersContainerInfo, ServerlessContainersDomainInfo, ServerlessContainersTriggerInfo, ServerlessFunctionsNamespaceInfo, ServerlessFunctionsFunctionInfo, ServerlessFunctionsDomainInfo, ServerlessFunctionsCronInfo, ServerlessFunctionsTriggerInfo, WoflWorkflowDefinitionInfo, WoflWorkflowRunInfo, WoflWorkflowVersionInfo must be set.
	ServerlessContainersTriggerInfo *ServerlessContainersTriggerInfo `json:"serverless_containers_trigger_info,omitempty"`

	// Precisely one of SecmSecretInfo, SecmSecretVersionInfo, KubeClusterInfo, KubePoolInfo, KubeNodeInfo, KubeACLInfo, KeymKeyInfo, SecretManagerSecretInfo, SecretManagerVersionInfo, KeyManagerKeyInfo, AccountUserInfo, AccountOrganizationInfo, InstanceServerInfo, AppleSiliconServerInfo, AccountProjectInfo, BaremetalServerInfo, BaremetalSettingInfo, IpamIPInfo, LoadBalancerLBInfo, LoadBalancerIPInfo, LoadBalancerFrontendInfo, LoadBalancerBackendInfo, LoadBalancerRouteInfo, LoadBalancerACLInfo, LoadBalancerCertificateInfo, EdgeServicesPlanInfo, EdgeServicesPipelineInfo, EdgeServicesDNSStageInfo, EdgeServicesTLSStageInfo, EdgeServicesCacheStageInfo, EdgeServicesRouteStageInfo, EdgeServicesRouteRulesInfo, EdgeServicesWafStageInfo, EdgeServicesBackendStageInfo, AccountContractSignatureInfo, VpcSubnetInfo, VpcRouteInfo, VpcPrivateNetworkInfo, AuditTrailExportJobInfo, VpcGwGatewayInfo, VpcGwGatewayNetworkInfo, AppleSiliconRunnerInfo, AuditTrailAlertRuleInfo, VpcConnectorInfo, InstancePrivateNetworkInterfaceInfo, VpcIngressRuleInfo, ObservabilityContactPointInfo, ObservabilityAlertRuleInfo, EdgeServicesVpcEndpointInfo, AuditTrailCustomAlertRuleInfo, ServerlessContainersNamespaceInfo, ServerlessContainersContainerInfo, ServerlessContainersDomainInfo, ServerlessContainersTriggerInfo, ServerlessFunctionsNamespaceInfo, ServerlessFunctionsFunctionInfo, ServerlessFunctionsDomainInfo, ServerlessFunctionsCronInfo, ServerlessFunctionsTriggerInfo, WoflWorkflowDefinitionInfo, WoflWorkflowRunInfo, WoflWorkflowVersionInfo must be set.
	ServerlessFunctionsNamespaceInfo *ServerlessFunctionsNamespaceInfo `json:"serverless_functions_namespace_info,omitempty"`

	// Precisely one of SecmSecretInfo, SecmSecretVersionInfo, KubeClusterInfo, KubePoolInfo, KubeNodeInfo, KubeACLInfo, KeymKeyInfo, SecretManagerSecretInfo, SecretManagerVersionInfo, KeyManagerKeyInfo, AccountUserInfo, AccountOrganizationInfo, InstanceServerInfo, AppleSiliconServerInfo, AccountProjectInfo, BaremetalServerInfo, BaremetalSettingInfo, IpamIPInfo, LoadBalancerLBInfo, LoadBalancerIPInfo, LoadBalancerFrontendInfo, LoadBalancerBackendInfo, LoadBalancerRouteInfo, LoadBalancerACLInfo, LoadBalancerCertificateInfo, EdgeServicesPlanInfo, EdgeServicesPipelineInfo, EdgeServicesDNSStageInfo, EdgeServicesTLSStageInfo, EdgeServicesCacheStageInfo, EdgeServicesRouteStageInfo, EdgeServicesRouteRulesInfo, EdgeServicesWafStageInfo, EdgeServicesBackendStageInfo, AccountContractSignatureInfo, VpcSubnetInfo, VpcRouteInfo, VpcPrivateNetworkInfo, AuditTrailExportJobInfo, VpcGwGatewayInfo, VpcGwGatewayNetworkInfo, AppleSiliconRunnerInfo, AuditTrailAlertRuleInfo, VpcConnectorInfo, InstancePrivateNetworkInterfaceInfo, VpcIngressRuleInfo, ObservabilityContactPointInfo, ObservabilityAlertRuleInfo, EdgeServicesVpcEndpointInfo, AuditTrailCustomAlertRuleInfo, ServerlessContainersNamespaceInfo, ServerlessContainersContainerInfo, ServerlessContainersDomainInfo, ServerlessContainersTriggerInfo, ServerlessFunctionsNamespaceInfo, ServerlessFunctionsFunctionInfo, ServerlessFunctionsDomainInfo, ServerlessFunctionsCronInfo, ServerlessFunctionsTriggerInfo, WoflWorkflowDefinitionInfo, WoflWorkflowRunInfo, WoflWorkflowVersionInfo must be set.
	ServerlessFunctionsFunctionInfo *ServerlessFunctionsFunctionInfo `json:"serverless_functions_function_info,omitempty"`

	// Precisely one of SecmSecretInfo, SecmSecretVersionInfo, KubeClusterInfo, KubePoolInfo, KubeNodeInfo, KubeACLInfo, KeymKeyInfo, SecretManagerSecretInfo, SecretManagerVersionInfo, KeyManagerKeyInfo, AccountUserInfo, AccountOrganizationInfo, InstanceServerInfo, AppleSiliconServerInfo, AccountProjectInfo, BaremetalServerInfo, BaremetalSettingInfo, IpamIPInfo, LoadBalancerLBInfo, LoadBalancerIPInfo, LoadBalancerFrontendInfo, LoadBalancerBackendInfo, LoadBalancerRouteInfo, LoadBalancerACLInfo, LoadBalancerCertificateInfo, EdgeServicesPlanInfo, EdgeServicesPipelineInfo, EdgeServicesDNSStageInfo, EdgeServicesTLSStageInfo, EdgeServicesCacheStageInfo, EdgeServicesRouteStageInfo, EdgeServicesRouteRulesInfo, EdgeServicesWafStageInfo, EdgeServicesBackendStageInfo, AccountContractSignatureInfo, VpcSubnetInfo, VpcRouteInfo, VpcPrivateNetworkInfo, AuditTrailExportJobInfo, VpcGwGatewayInfo, VpcGwGatewayNetworkInfo, AppleSiliconRunnerInfo, AuditTrailAlertRuleInfo, VpcConnectorInfo, InstancePrivateNetworkInterfaceInfo, VpcIngressRuleInfo, ObservabilityContactPointInfo, ObservabilityAlertRuleInfo, EdgeServicesVpcEndpointInfo, AuditTrailCustomAlertRuleInfo, ServerlessContainersNamespaceInfo, ServerlessContainersContainerInfo, ServerlessContainersDomainInfo, ServerlessContainersTriggerInfo, ServerlessFunctionsNamespaceInfo, ServerlessFunctionsFunctionInfo, ServerlessFunctionsDomainInfo, ServerlessFunctionsCronInfo, ServerlessFunctionsTriggerInfo, WoflWorkflowDefinitionInfo, WoflWorkflowRunInfo, WoflWorkflowVersionInfo must be set.
	ServerlessFunctionsDomainInfo *ServerlessFunctionsDomainInfo `json:"serverless_functions_domain_info,omitempty"`

	// Precisely one of SecmSecretInfo, SecmSecretVersionInfo, KubeClusterInfo, KubePoolInfo, KubeNodeInfo, KubeACLInfo, KeymKeyInfo, SecretManagerSecretInfo, SecretManagerVersionInfo, KeyManagerKeyInfo, AccountUserInfo, AccountOrganizationInfo, InstanceServerInfo, AppleSiliconServerInfo, AccountProjectInfo, BaremetalServerInfo, BaremetalSettingInfo, IpamIPInfo, LoadBalancerLBInfo, LoadBalancerIPInfo, LoadBalancerFrontendInfo, LoadBalancerBackendInfo, LoadBalancerRouteInfo, LoadBalancerACLInfo, LoadBalancerCertificateInfo, EdgeServicesPlanInfo, EdgeServicesPipelineInfo, EdgeServicesDNSStageInfo, EdgeServicesTLSStageInfo, EdgeServicesCacheStageInfo, EdgeServicesRouteStageInfo, EdgeServicesRouteRulesInfo, EdgeServicesWafStageInfo, EdgeServicesBackendStageInfo, AccountContractSignatureInfo, VpcSubnetInfo, VpcRouteInfo, VpcPrivateNetworkInfo, AuditTrailExportJobInfo, VpcGwGatewayInfo, VpcGwGatewayNetworkInfo, AppleSiliconRunnerInfo, AuditTrailAlertRuleInfo, VpcConnectorInfo, InstancePrivateNetworkInterfaceInfo, VpcIngressRuleInfo, ObservabilityContactPointInfo, ObservabilityAlertRuleInfo, EdgeServicesVpcEndpointInfo, AuditTrailCustomAlertRuleInfo, ServerlessContainersNamespaceInfo, ServerlessContainersContainerInfo, ServerlessContainersDomainInfo, ServerlessContainersTriggerInfo, ServerlessFunctionsNamespaceInfo, ServerlessFunctionsFunctionInfo, ServerlessFunctionsDomainInfo, ServerlessFunctionsCronInfo, ServerlessFunctionsTriggerInfo, WoflWorkflowDefinitionInfo, WoflWorkflowRunInfo, WoflWorkflowVersionInfo must be set.
	ServerlessFunctionsCronInfo *ServerlessFunctionsCronInfo `json:"serverless_functions_cron_info,omitempty"`

	// Precisely one of SecmSecretInfo, SecmSecretVersionInfo, KubeClusterInfo, KubePoolInfo, KubeNodeInfo, KubeACLInfo, KeymKeyInfo, SecretManagerSecretInfo, SecretManagerVersionInfo, KeyManagerKeyInfo, AccountUserInfo, AccountOrganizationInfo, InstanceServerInfo, AppleSiliconServerInfo, AccountProjectInfo, BaremetalServerInfo, BaremetalSettingInfo, IpamIPInfo, LoadBalancerLBInfo, LoadBalancerIPInfo, LoadBalancerFrontendInfo, LoadBalancerBackendInfo, LoadBalancerRouteInfo, LoadBalancerACLInfo, LoadBalancerCertificateInfo, EdgeServicesPlanInfo, EdgeServicesPipelineInfo, EdgeServicesDNSStageInfo, EdgeServicesTLSStageInfo, EdgeServicesCacheStageInfo, EdgeServicesRouteStageInfo, EdgeServicesRouteRulesInfo, EdgeServicesWafStageInfo, EdgeServicesBackendStageInfo, AccountContractSignatureInfo, VpcSubnetInfo, VpcRouteInfo, VpcPrivateNetworkInfo, AuditTrailExportJobInfo, VpcGwGatewayInfo, VpcGwGatewayNetworkInfo, AppleSiliconRunnerInfo, AuditTrailAlertRuleInfo, VpcConnectorInfo, InstancePrivateNetworkInterfaceInfo, VpcIngressRuleInfo, ObservabilityContactPointInfo, ObservabilityAlertRuleInfo, EdgeServicesVpcEndpointInfo, AuditTrailCustomAlertRuleInfo, ServerlessContainersNamespaceInfo, ServerlessContainersContainerInfo, ServerlessContainersDomainInfo, ServerlessContainersTriggerInfo, ServerlessFunctionsNamespaceInfo, ServerlessFunctionsFunctionInfo, ServerlessFunctionsDomainInfo, ServerlessFunctionsCronInfo, ServerlessFunctionsTriggerInfo, WoflWorkflowDefinitionInfo, WoflWorkflowRunInfo, WoflWorkflowVersionInfo must be set.
	ServerlessFunctionsTriggerInfo *ServerlessFunctionsTriggerInfo `json:"serverless_functions_trigger_info,omitempty"`

	// Precisely one of SecmSecretInfo, SecmSecretVersionInfo, KubeClusterInfo, KubePoolInfo, KubeNodeInfo, KubeACLInfo, KeymKeyInfo, SecretManagerSecretInfo, SecretManagerVersionInfo, KeyManagerKeyInfo, AccountUserInfo, AccountOrganizationInfo, InstanceServerInfo, AppleSiliconServerInfo, AccountProjectInfo, BaremetalServerInfo, BaremetalSettingInfo, IpamIPInfo, LoadBalancerLBInfo, LoadBalancerIPInfo, LoadBalancerFrontendInfo, LoadBalancerBackendInfo, LoadBalancerRouteInfo, LoadBalancerACLInfo, LoadBalancerCertificateInfo, EdgeServicesPlanInfo, EdgeServicesPipelineInfo, EdgeServicesDNSStageInfo, EdgeServicesTLSStageInfo, EdgeServicesCacheStageInfo, EdgeServicesRouteStageInfo, EdgeServicesRouteRulesInfo, EdgeServicesWafStageInfo, EdgeServicesBackendStageInfo, AccountContractSignatureInfo, VpcSubnetInfo, VpcRouteInfo, VpcPrivateNetworkInfo, AuditTrailExportJobInfo, VpcGwGatewayInfo, VpcGwGatewayNetworkInfo, AppleSiliconRunnerInfo, AuditTrailAlertRuleInfo, VpcConnectorInfo, InstancePrivateNetworkInterfaceInfo, VpcIngressRuleInfo, ObservabilityContactPointInfo, ObservabilityAlertRuleInfo, EdgeServicesVpcEndpointInfo, AuditTrailCustomAlertRuleInfo, ServerlessContainersNamespaceInfo, ServerlessContainersContainerInfo, ServerlessContainersDomainInfo, ServerlessContainersTriggerInfo, ServerlessFunctionsNamespaceInfo, ServerlessFunctionsFunctionInfo, ServerlessFunctionsDomainInfo, ServerlessFunctionsCronInfo, ServerlessFunctionsTriggerInfo, WoflWorkflowDefinitionInfo, WoflWorkflowRunInfo, WoflWorkflowVersionInfo must be set.
	WoflWorkflowDefinitionInfo *WoflWorkflowDefinitionInfo `json:"wofl_workflow_definition_info,omitempty"`

	// Precisely one of SecmSecretInfo, SecmSecretVersionInfo, KubeClusterInfo, KubePoolInfo, KubeNodeInfo, KubeACLInfo, KeymKeyInfo, SecretManagerSecretInfo, SecretManagerVersionInfo, KeyManagerKeyInfo, AccountUserInfo, AccountOrganizationInfo, InstanceServerInfo, AppleSiliconServerInfo, AccountProjectInfo, BaremetalServerInfo, BaremetalSettingInfo, IpamIPInfo, LoadBalancerLBInfo, LoadBalancerIPInfo, LoadBalancerFrontendInfo, LoadBalancerBackendInfo, LoadBalancerRouteInfo, LoadBalancerACLInfo, LoadBalancerCertificateInfo, EdgeServicesPlanInfo, EdgeServicesPipelineInfo, EdgeServicesDNSStageInfo, EdgeServicesTLSStageInfo, EdgeServicesCacheStageInfo, EdgeServicesRouteStageInfo, EdgeServicesRouteRulesInfo, EdgeServicesWafStageInfo, EdgeServicesBackendStageInfo, AccountContractSignatureInfo, VpcSubnetInfo, VpcRouteInfo, VpcPrivateNetworkInfo, AuditTrailExportJobInfo, VpcGwGatewayInfo, VpcGwGatewayNetworkInfo, AppleSiliconRunnerInfo, AuditTrailAlertRuleInfo, VpcConnectorInfo, InstancePrivateNetworkInterfaceInfo, VpcIngressRuleInfo, ObservabilityContactPointInfo, ObservabilityAlertRuleInfo, EdgeServicesVpcEndpointInfo, AuditTrailCustomAlertRuleInfo, ServerlessContainersNamespaceInfo, ServerlessContainersContainerInfo, ServerlessContainersDomainInfo, ServerlessContainersTriggerInfo, ServerlessFunctionsNamespaceInfo, ServerlessFunctionsFunctionInfo, ServerlessFunctionsDomainInfo, ServerlessFunctionsCronInfo, ServerlessFunctionsTriggerInfo, WoflWorkflowDefinitionInfo, WoflWorkflowRunInfo, WoflWorkflowVersionInfo must be set.
	WoflWorkflowRunInfo *WoflWorkflowRunInfo `json:"wofl_workflow_run_info,omitempty"`

	// Precisely one of SecmSecretInfo, SecmSecretVersionInfo, KubeClusterInfo, KubePoolInfo, KubeNodeInfo, KubeACLInfo, KeymKeyInfo, SecretManagerSecretInfo, SecretManagerVersionInfo, KeyManagerKeyInfo, AccountUserInfo, AccountOrganizationInfo, InstanceServerInfo, AppleSiliconServerInfo, AccountProjectInfo, BaremetalServerInfo, BaremetalSettingInfo, IpamIPInfo, LoadBalancerLBInfo, LoadBalancerIPInfo, LoadBalancerFrontendInfo, LoadBalancerBackendInfo, LoadBalancerRouteInfo, LoadBalancerACLInfo, LoadBalancerCertificateInfo, EdgeServicesPlanInfo, EdgeServicesPipelineInfo, EdgeServicesDNSStageInfo, EdgeServicesTLSStageInfo, EdgeServicesCacheStageInfo, EdgeServicesRouteStageInfo, EdgeServicesRouteRulesInfo, EdgeServicesWafStageInfo, EdgeServicesBackendStageInfo, AccountContractSignatureInfo, VpcSubnetInfo, VpcRouteInfo, VpcPrivateNetworkInfo, AuditTrailExportJobInfo, VpcGwGatewayInfo, VpcGwGatewayNetworkInfo, AppleSiliconRunnerInfo, AuditTrailAlertRuleInfo, VpcConnectorInfo, InstancePrivateNetworkInterfaceInfo, VpcIngressRuleInfo, ObservabilityContactPointInfo, ObservabilityAlertRuleInfo, EdgeServicesVpcEndpointInfo, AuditTrailCustomAlertRuleInfo, ServerlessContainersNamespaceInfo, ServerlessContainersContainerInfo, ServerlessContainersDomainInfo, ServerlessContainersTriggerInfo, ServerlessFunctionsNamespaceInfo, ServerlessFunctionsFunctionInfo, ServerlessFunctionsDomainInfo, ServerlessFunctionsCronInfo, ServerlessFunctionsTriggerInfo, WoflWorkflowDefinitionInfo, WoflWorkflowRunInfo, WoflWorkflowVersionInfo must be set.
	WoflWorkflowVersionInfo *WoflWorkflowVersionInfo `json:"wofl_workflow_version_info,omitempty"`
}
