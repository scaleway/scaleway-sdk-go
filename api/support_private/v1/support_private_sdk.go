...
// Package support_private provides methods and message types of the support_private v1 API.
package support_private
...
import (
	...
	"gitlab.infra.online.net/devtools/scaleway-sdk-go-internal/support_private/v1/internal/errors"
	"gitlab.infra.online.net/devtools/scaleway-sdk-go-internal/support_private/v1/internal/marshaler"
	"gitlab.infra.online.net/devtools/scaleway-sdk-go-internal/support_private/v1/internal/parameter"
	"gitlab.infra.online.net/devtools/scaleway-sdk-go-internal/support_private/v1/namegenerator"
	"gitlab.infra.online.net/devtools/scaleway-sdk-go-internal/support_private/v1/scw"
)
...
func (s *API) ListTickets(req *ListTicketsRequest, opts ...scw.RequestOption) (*ListTicketsResponse, error) {
	...
	scwReq := &scw.ScalewayRequest{
		Method: "GET",
		Path:   "/support-private/v1/tickets",
		Query:  query,
	}
...
func (s *API) GetTicket(req *GetTicketRequest, opts ...scw.RequestOption) (*Ticket, error) {
	...
	scwReq := &scw.ScalewayRequest{
		Method: "GET",
		Path:   "/support-private/v1/tickets/" + fmt.Sprint(req.TicketID) + "",
	}
...
func (s *API) AddTicketAnswer(req *AddTicketAnswerRequest, opts ...scw.RequestOption) (*Ticket, error) {
	...
	scwReq := &scw.ScalewayRequest{
		Method: "POST",
		Path:   "/support-private/v1/tickets/" + fmt.Sprint(req.TicketID) + "/answer",
	}
...
func (s *API) CloseTicket(req *CloseTicketRequest, opts ...scw.RequestOption) error {
	...
	scwReq := &scw.ScalewayRequest{
		Method: "POST",
		Path:   "/support-private/v1/tickets/" + fmt.Sprint(req.TicketID) + "/close",
	}
...
func (s *API) EscalateTicket(req *EscalateTicketRequest, opts ...scw.RequestOption) (*Ticket, error) {
	...
	scwReq := &scw.ScalewayRequest{
		Method: "POST",
		Path:   "/support-private/v1/tickets/" + fmt.Sprint(req.TicketID) + "/escalate",
	}
