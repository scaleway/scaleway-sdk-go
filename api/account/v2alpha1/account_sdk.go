...
const (
	...
	// ListProjectsRequestOrderByNameAtAsc is [insert doc].
	ListProjectsRequestOrderByNameAtAsc = ListProjectsRequestOrderBy("name_at_asc")
	// ListProjectsRequestOrderByNameAtDesc is [insert doc].
	ListProjectsRequestOrderByNameAtDesc = ListProjectsRequestOrderBy("name_at_desc")
)
...
//
// Projects enable to organize product-resources into groups.
func (s *API) CreateProject(req *CreateProjectRequest, opts ...scw.RequestOption) (*Project, error) {
	...
	scwReq := &scw.ScalewayRequest{
		Method:  "POST",
		Path:    "/account/v2alpha1/projects",
		Headers: http.Header{},
	}
...
func (s *API) GetProject(req *GetProjectRequest, opts ...scw.RequestOption) (*Project, error) {
	...
	scwReq := &scw.ScalewayRequest{
		Method:  "GET",
		Path:    "/account/v2alpha1/projects/" + fmt.Sprint(req.ProjectID) + "",
		Headers: http.Header{},
	}
