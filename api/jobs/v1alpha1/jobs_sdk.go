...
import (
	...
	"gitlab.infra.online.net/devtools/scaleway-sdk-go-internal/jobs/v1alpha1/internal/errors"
	"gitlab.infra.online.net/devtools/scaleway-sdk-go-internal/jobs/v1alpha1/internal/marshaler"
	"gitlab.infra.online.net/devtools/scaleway-sdk-go-internal/jobs/v1alpha1/internal/parameter"
	"gitlab.infra.online.net/devtools/scaleway-sdk-go-internal/jobs/v1alpha1/namegenerator"
	"gitlab.infra.online.net/devtools/scaleway-sdk-go-internal/jobs/v1alpha1/scw"
)
...
func (s *API) GetServiceInfo(req *GetServiceInfoRequest, opts ...scw.RequestOption) (*scw.ServiceInfo, error) {
	...
	scwReq := &scw.ScalewayRequest{
		Method: "GET",
		Path:   "/serverless-jobs/v1alpha1/regions/" + fmt.Sprint(req.Region) + "",
	}
