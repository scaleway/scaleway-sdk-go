...
const (
	...
	// Order consumptions by category (descending alphabetical order).
	ListConsumptionsRequestOrderByCategoryDesc = ListConsumptionsRequestOrderBy("category_desc")
	// Order consumptions by category (ascending alphabetical order).
	ListConsumptionsRequestOrderByCategoryAsc = ListConsumptionsRequestOrderBy("category_asc")
)
...
const (
	...
	// Order consumptions by category (descending alphabetical order).
	ListTaxesRequestOrderByCategoryDesc = ListTaxesRequestOrderBy("category_desc")
	// Order consumptions by category (ascending alphabetical order).
	ListTaxesRequestOrderByCategoryAsc = ListTaxesRequestOrderBy("category_asc")
)
...
type ListConsumptionsRequest struct {
	...
	// Category: filter by product category, such as Compute, Network, Observability.
	Category *string `json:"-"`

	// BillingPeriod: filter by the billing period in the format YYYY-MM. If it is empty the current billing period will be used as default.
...
// ListTaxes: Consumption Tax allows you to retrieve your past or current tax cost, by project or category.
