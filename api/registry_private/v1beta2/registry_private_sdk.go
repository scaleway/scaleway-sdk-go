...
// Package registry_private provides methods and message types of the registry_private v1beta2 API.
...
import (
	...
	"gitlab.infra.online.net/devtools/scaleway-sdk-go-internal/registry_private/v1beta2/internal/errors"
	"gitlab.infra.online.net/devtools/scaleway-sdk-go-internal/registry_private/v1beta2/internal/marshaler"
	"gitlab.infra.online.net/devtools/scaleway-sdk-go-internal/registry_private/v1beta2/internal/parameter"
	"gitlab.infra.online.net/devtools/scaleway-sdk-go-internal/registry_private/v1beta2/namegenerator"
	"gitlab.infra.online.net/devtools/scaleway-sdk-go-internal/registry_private/v1beta2/scw"
)
...
func (s *StatsAPI) GetStats(req *StatsAPIGetStatsRequest, opts ...scw.RequestOption) (*GetStatsResponse, error) {
	...
	scwReq := &scw.ScalewayRequest{
		Method: "GET",
		Path:   "/registry-private/v1beta2/regions/" + fmt.Sprint(req.Region) + "/stats",
		Query:  query,
	}
...
func (s *StatsAPI) GetPricing(req *StatsAPIGetPricingRequest, opts ...scw.RequestOption) (*GetPricingResponse, error) {
	...
	scwReq := &scw.ScalewayRequest{
		Method: "GET",
		Path:   "/registry-private/v1beta2/regions/" + fmt.Sprint(req.Region) + "/pricing",
	}
...
func (s *StatsAPI) GetNamespaceStats(req *StatsAPIGetNamespaceStatsRequest, opts ...scw.RequestOption) (*GetNamespaceStatsResponse, error) {
	...
	scwReq := &scw.ScalewayRequest{
		Method: "GET",
		Path:   "/registry-private/v1beta2/regions/" + fmt.Sprint(req.Region) + "/namespaces/" + fmt.Sprint(req.NamespaceID) + "/stats",
		Query:  query,
	}
...
func (s *StatsAPI) GetImageStats(req *StatsAPIGetImageStatsRequest, opts ...scw.RequestOption) (*GetImageStatsResponse, error) {
	...
	scwReq := &scw.ScalewayRequest{
		Method: "GET",
		Path:   "/registry-private/v1beta2/regions/" + fmt.Sprint(req.Region) + "/images/" + fmt.Sprint(req.ImageID) + "/stats",
		Query:  query,
	}
