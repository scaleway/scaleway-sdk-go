...
// Package document_db_private provides methods and message types of the document_db_private v1beta1 API.
package document_db_private
...
import (
	...
	"gitlab.infra.online.net/devtools/scaleway-sdk-go-internal/document_db_private/v1beta1/internal/errors"
	"gitlab.infra.online.net/devtools/scaleway-sdk-go-internal/document_db_private/v1beta1/internal/marshaler"
	"gitlab.infra.online.net/devtools/scaleway-sdk-go-internal/document_db_private/v1beta1/internal/parameter"
	"gitlab.infra.online.net/devtools/scaleway-sdk-go-internal/document_db_private/v1beta1/namegenerator"
	"gitlab.infra.online.net/devtools/scaleway-sdk-go-internal/document_db_private/v1beta1/scw"
)
...
func (s *ConsoleAPI) GetServiceInfo(req *ConsoleAPIGetServiceInfoRequest, opts ...scw.RequestOption) (*scw.ServiceInfo, error) {
	...
	scwReq := &scw.ScalewayRequest{
		Method: "GET",
		Path:   "/document-db-private/v1beta1/regions/" + fmt.Sprint(req.Region) + "",
	}
...
func (s *ConsoleAPI) GetDashboard(req *ConsoleAPIGetDashboardRequest, opts ...scw.RequestOption) (*Dashboard, error) {
	...
	scwReq := &scw.ScalewayRequest{
		Method: "GET",
		Path:   "/document-db-private/v1beta1/regions/" + fmt.Sprint(req.Region) + "/instances/dashboard",
		Query:  query,
	}
...
func (s *ConsoleAPI) GetInstanceDashboard(req *ConsoleAPIGetInstanceDashboardRequest, opts ...scw.RequestOption) (*InstanceDashboard, error) {
	...
	scwReq := &scw.ScalewayRequest{
		Method: "GET",
		Path:   "/document-db-private/v1beta1/regions/" + fmt.Sprint(req.Region) + "/instances/" + fmt.Sprint(req.InstanceID) + "/dashboard",
	}
...
func (s *ConsoleAPI) ListInstanceEvents(req *ConsoleAPIListInstanceEventsRequest, opts ...scw.RequestOption) (*ListInstanceEventsResponse, error) {
	...
	scwReq := &scw.ScalewayRequest{
		Method: "GET",
		Path:   "/document-db-private/v1beta1/regions/" + fmt.Sprint(req.Region) + "/instances/" + fmt.Sprint(req.InstanceID) + "/events",
		Query:  query,
	}
